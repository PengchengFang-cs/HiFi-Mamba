...
DEFAULT_OUTPUT_DIR = os.path.join(REPO_ROOT, "outputs", "fastmri")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_data_dir', type=str, required=True, help='Path to fastMRI singlecoil_train directory.')
    parser.add_argument('--val_data_dir', type=str, required=True, help='Path to fastMRI singlecoil_val directory.')
    ...
    parser.add_argument('--name', type=str, default='fastmri_8x_able_8x2')
