...
def main_worker(args):
    ...
    if args.model == "mamba_unrolled":
        from networks.vision_mamba_sp import MambaUnrolled as VIM_seg
    elif args.model == "mamba_unet":
        from networks.vision_mamba_sp import MambaUnet as VIM_seg
    ...
    for epoch in range(start_epoch, max_epoch + 1):
        ...
        for i_batch, sampled_batch in enumerate(pbar):
            ...
            print(us_mask.shape, coil_maps.shape)
