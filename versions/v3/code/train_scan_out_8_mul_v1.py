...
def main_worker(args):
    ...
    train_dataset = SliceData_multi(
        ...
        mask_path="/scratch/pf2m24/projects/MRIRecon/MambaReconV3/code/dataloaders/multi_mask/mask_0_256_af8.npy"
    )
...
if __name__ == "__main__":
    ...
    #parser.add_argument('--resume', default='/scratch/pf2m24/projects/MRIRecon/MambaReconV3/model/mamba_unrolled_140_Patch_1_mul_8_P1_v1/mamba_unrolled/mamba_unrolled_latest_model.pth')
