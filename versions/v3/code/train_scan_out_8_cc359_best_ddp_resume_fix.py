...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', default='/scratch/pf2m24/projects/MRIRecon/MambaReconV2/model/mamba_unrolled_140_Patch_2_cc359_resume_test/mamba_unrolled/mamba_unrolled_test_model.pth')
