...
def main_worker(args):
    ...
    warmup_steps    = 5 * steps_per_epoch            # 对齐你原来 warmup_epochs=5

    # 按 iter 的 warmup -> cosine 串联调度
    ...
    if args.resume is not None and os.path.isfile(args.resume):
        ...
        # 立刻把 optimizer 的 lr 与 scheduler 对齐（可选但推荐）
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', default='/scratch/pf2m24/projects/MRIRecon/MambaReconV2/model/mamba_unrolled_140_Patch_1_fastmri_8x_final_8x2_p1_h200/mamba_unrolled/mamba_unrolled_best_ssim_model.pth')
