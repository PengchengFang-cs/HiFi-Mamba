...
from dataloaders.ACDC_dataset_r32 import SliceData_ACDC
...
def main_worker(args):
    ...
    if args.model == "mamba_unrolled":
        from networks.vision_mamba_v1 import MambaUnrolled as VIM_seg
    ...
    # 数据集与采样器
    train_dataset = SliceData_ACDC(
        data_dir="/scratch/pf2m24/data/ACDC/training",
        mask_path="/scratch/pf2m24/projects/MRIRecon/MambaReconV3/code/dataloaders/radial_mask/radial_mask_32.npy"
    )
    
    val_dataset = SliceData_ACDC(
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default='ACDC_16')
