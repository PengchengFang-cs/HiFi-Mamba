...
if args.model == "mamba_unrolled":
    from networks.vision_mamba_og import MambaUnrolled as VIM_seg
elif args.model == "mamba_unet":
    from networks.vision_mamba_og import MambaUnet as VIM_seg
...
def train(args, snapshot_path):
    ...
    train_dataset = SliceData_CC359(data_dir="/scratch/pf2m24/data/CCP359/Train/")
    val_dataset = SliceData_CC359("/scratch/pf2m24/data/CCP359/Val/")
...
if __name__ == "__main__":
    ...
    snapshot_path = "../model/{}_{}_og_CC_4/{}".format(
