...
class SliceData_pro(Dataset):
    def __init__(self, 
                data_dir="/scratch/pf2m24/data/prostate158/prostate158_train/train", mask_path="/scratch/pf2m24/projects/MRIRecon/MambaReconV3/code/dataloaders/random_mask/random_224_4.npy"):
