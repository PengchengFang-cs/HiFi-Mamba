...
from dataloaders.fastMRI_dataset_PGIUN_fastmri_4 import fastMRI_dataset
...
parser.add_argument('--exp', type=str,
                    default='mamba_unrolled_4fastmri', help='experiment_name')
...
if __name__ == "__main__":
    ...
    snapshot_path = "../model/{}_{}_labeled/{}_4fastmri".format(
