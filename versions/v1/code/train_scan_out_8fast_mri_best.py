...
def train(args, snapshot_path):
    ...
    for epoch in range(1, max_epoch+1):
        ...
        tbar = tqdm(valloader, ncols=130, desc=f'Validate {epoch}')
        with torch.no_grad():
        ...
        logging.info(f'Slice Epoch {epoch}: Validation PSNR: {total_psnr:.4f}, RMSE: {total_rmse:.4f}, SSIM: {total_ssim:.4f}')
...
if __name__ == "__main__":
    ...
    # snapshot_path = "../model/{}_{}_labeled_scan_out_noduelchange/{}".format(
    snapshot_path = "../model/{}_{}_labeled_scan_out_p2_geo/{}".format(
