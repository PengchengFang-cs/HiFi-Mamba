...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', default='/scratch/pf2m24/projects/MRIRecon/MambaRecon/model/mamba_unrolled_140_patch1_h100_seed_1337/mamba_unrolled/mamba_unrolled_best_psnr_model.pth', help='resume from checkpoint')
