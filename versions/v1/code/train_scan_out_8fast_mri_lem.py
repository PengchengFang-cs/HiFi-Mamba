...
def adjust_learning_rate(optimizer, epoch, total_epochs=100, lr=2e-4, warmup_epochs=5, min_lr=1e-6):
...
if __name__ == "__main__":
    ...
    snapshot_path = "../model/{}_{}_labeled_scan_out_Huawei_high/{}".format(
